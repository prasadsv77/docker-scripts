...
{{- $ingressenabled := list true false -}}
{{- if not (has .Values.ingress.enabled $ingressenabled) -}}
{{- fail ".Values.ingress.enabled is invalid boolean, allowed values are true or false" -}}
{{- end -}}

{{- if (eq .Values.ingress.enabled true) -}}
{{- include "validatefn" (dict "path" "ingress.masterServerIP" "values" .Values) -}}
{{- end -}}
...
{{- include "validatefn" (dict "path" "adminDeployment.maxUnavailable" "values" .Values "numeric" "true") -}}
...
{{- include "validatefn" (dict "path" "appDeployment.maxUnavailable" "values" .Values "numeric" "true") -}}
...
{{- include "validatefn" (dict "path" "bgDeployment.maxUnavailable" "values" .Values "numeric" "true") -}}
...
{{- include "validatefn" (dict "path" "xogDeployment.maxUnavailable" "values" .Values "numeric" "true") -}}
