...
public class Constants
{
  ...
  public static final String PPM_DB_URL_KEY = "PPM_DB_URL";
  public static final String PPM_DWH_URL_KEY = "PPM_DWH_URL";
  ...
  public enum MsgValues
  {
    ...
    INVALID_RANGE( "Invalid range, the values should be within the range" );
